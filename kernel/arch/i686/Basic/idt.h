...
// 32～255 用户自定义异常
//---------------------------------------------------------------------------
extern void isr0x60();		// 0x60 系统中断（Syscall）
													// 不使用int 0x80，int 0x80用于兼容unix/linux syscall
//---------------------------------------------------------------------------
// ● isr处理函数
//---------------------------------------------------------------------------
extern void isr_handler(pt_regs *regs);
//---------------------------------------------------------------------------
// ● irq处理函数
//---------------------------------------------------------------------------
extern void irq_handler(pt_regs *regs);
//---------------------------------------------------------------------------
// 定义IRQ
//---------------------------------------------------------------------------
