...
// ● 注册一个中断处理函数
//---------------------------------------------------------------------------
void IDT_register_interrupt_handler(uint8_t n, IDT_interrupt_handler_t h);
...
// ● isr处理函数
//---------------------------------------------------------------------------
extern void isr_handler(IDT_pt_regs *regs);
//---------------------------------------------------------------------------
// ● irq处理函数
//---------------------------------------------------------------------------
extern void irq_handler(IDT_pt_regs *regs);
//---------------------------------------------------------------------------
// 定义IRQ
//---------------------------------------------------------------------------
...
// ● 中断处理函数的指针数组
//---------------------------------------------------------------------------
extern IDT_interrupt_handler_t interrupt_handlers[256];
